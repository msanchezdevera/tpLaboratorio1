...
public class TarjetaH2DAO implements Dao<Tarjeta> {
    ...
    public int insertar(Tarjeta tarjeta) throws DatabaseException {
        String query = String.format(
                ...
                "VALUES ('%s', '%s', %.2f, %.2f, %d)",
                tarjeta.getNumeroTarjeta(), tarjeta.getTipo(), tarjeta.getLimiteCredito(),
                tarjeta.getSaldoUtilizado(), tarjeta.getUsuarioId());
    ...
    public void actualizar(Tarjeta tarjeta) throws DatabaseException {
        String query = String.format(
                ...
                tarjeta.getNumeroTarjeta(), tarjeta.getTipo(), tarjeta.getLimiteCredito(),
                tarjeta.getSaldoUtilizado(), tarjeta.getUsuarioId(), tarjeta.getId());
