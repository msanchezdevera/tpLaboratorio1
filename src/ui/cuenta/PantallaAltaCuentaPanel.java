...
public class PantallaAltaCuentaPanel extends FormularioCuentaBancariaPanel {
    ...
    private void guardarCuentaBancaria() {
        try {
            ...
            service.crearCuentaBancaria(txtNumeroCuenta.getText(), Double.parseDouble(txtSaldo.getText()), tipoCuentaSeleccionado, Integer.parseInt(txtClienteId.getText()), txtCbu.getText(), txtAlias.getText());
            ...
            JOptionPane.showMessageDialog(PantallaAltaCuentaPanel.this,
                    "El saldo, el ID del cliente, el CBU y el Alias deben ser valores numéricos donde corresponda.", "Error de validación",
