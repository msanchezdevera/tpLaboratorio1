...
public class PantallaTransferenciaPanel extends JPanel {
    ...
    public PantallaTransferenciaPanel(PanelManager panelManager, CuentaBancariaService service, CuentaBancaria cuentaOrigen) {
    ...
    private void realizarTransferencia() {
        try {
            ...
            JOptionPane.showMessageDialog(PantallaTransferenciaPanel.this,
                    "El monto debe ser un valor numérico.", "Error de validación",
                    JOptionPane.ERROR_MESSAGE);
        } catch (MenorACeroException ex) {
            JOptionPane.showMessageDialog(PantallaTransferenciaPanel.this,
                    "El monto debe ser mayor a cero.", "Error de validación",
                    JOptionPane.ERROR_MESSAGE);
        } catch (CuentaBancariaNoEncontradaException ex) {
            JOptionPane.showMessageDialog(PantallaTransferenciaPanel.this,
                    "La cuenta destino no fue encontrada.", "Error", JOptionPane.ERROR_MESSAGE);
