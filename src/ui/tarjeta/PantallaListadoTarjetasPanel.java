...
public class PantallaListadoTarjetasPanel extends JPanel {
	...
	private void obtenerTarjetas(JLabel lblTitulo) {
		try {
			...
			JOptionPane.showMessageDialog(this, "Error al obtener tarjetas, pruebe más tarde: " + e.getMessage(),
	...
	private void eliminarTarjeta() {
		int selectedRow = tableTarjetas.getSelectedRow();
		if (selectedRow == -1) {
			JOptionPane.showMessageDialog(PantallaListadoTarjetasPanel.this, "Seleccione una tarjeta para eliminar.",
