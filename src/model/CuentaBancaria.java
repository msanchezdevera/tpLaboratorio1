...
public class CuentaBancaria {
	...
	public CuentaBancaria(String numeroCuenta, double saldo, String tipoCuenta, Integer clienteId)
	...
	public CuentaBancaria(int id, String numeroCuenta, double saldo, String tipoCuenta, Integer clienteId)
			throws TipoCuentaBancariaInvalidaException {
		validarTipoCuenta(tipoCuenta);
		this.id = id;
		this.numeroCuenta = numeroCuenta;
	...
	public String toString() {
		return "CuentaBancaria{id='" + id + "',numeroCuenta='" + numeroCuenta + "', saldo=" + saldo + ", tipoCuenta='"
				+ tipoCuenta + "', clienteId=" + clienteId + "}";
	}
