...
public class Tarjeta {
    ...
    public Tarjeta(String numeroTarjeta, String tipo, double limiteCredito, double saldoUtilizado, Integer usuarioId) throws TipoTarjetaInvalidaException {
    ...
    public Tarjeta(int id, String numeroTarjeta, String tipo, double limiteCredito, double saldoUtilizado, Integer usuarioId) throws TipoTarjetaInvalidaException {
        validarTipoTarjeta(tipo);
        this.id = id;
        this.numeroTarjeta = numeroTarjeta;
        this.tipo = tipo;
    ...
    public String toString() {
        return "Tarjeta{id=" + id + ", numeroTarjeta='" + numeroTarjeta + "', tipo='" + tipo +
                "', limiteCredito=" + limiteCredito + ", saldoUtilizado=" + saldoUtilizado +
                ", saldoDisponible=" + saldoDisponible + ", usuarioId=" + usuarioId + "}";
    }
