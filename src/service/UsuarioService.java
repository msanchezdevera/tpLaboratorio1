...
public class UsuarioService {
    ...
    public Usuario obtenerUsuarioPorEmail(String email) throws UsuarioNoEncontradoException, UsuarioServiceException {
        try {
            Usuario usuario = usuarioDAO.buscarPorEmail(email);
            if (usuario == null) {
                throw new UsuarioNoEncontradoException("El usuario con email " + email + " no fue encontrado.");
            }
            return usuario;
        } catch (DatabaseException e) {
            throw new UsuarioServiceException("Error al obtener el usuario con email " + email, e);
        }
    }
