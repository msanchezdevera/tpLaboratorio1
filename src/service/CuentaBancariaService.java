...
public class CuentaBancariaService {
    ...
    public CuentaBancaria crearCuentaBancaria(String numeroCuenta, double saldo, String tipoCuenta, int clienteId, String cbu, String alias)
            throws TipoCuentaBancariaInvalidaException, TextoVacioException, MenorACeroException,
            ValorNoNumericoException, CuentaBancariaServiceException {
        try {
    ...
    public void actualizarCuentaBancaria(int cuentaId, double nuevoSaldo, String nuevoTipoCuenta, String nuevoCbu, String nuevoAlias)
    ...
    public void realizarTransferencia(CuentaBancaria cuentaOrigen, String cuentaDestinoInput, double monto)
        ...
        try {
            CuentaBancaria cuentaDestino = cuentaBancariaDAO.buscarPorNumeroCuenta(cuentaDestinoInput);
            ...
            if (cuentaOrigen.getSaldo() < monto) {
                throw new CuentaBancariaServiceException("La cuenta de origen no tiene suficiente saldo para realizar la transferencia.");
            }

            cuentaOrigen.setSaldo(cuentaOrigen.getSaldo() - monto);
            cuentaDestino.setSaldo(cuentaDestino.getSaldo() + monto);

            cuentaBancariaDAO.actualizarSaldoEnTransaccion(cuentaOrigen, cuentaDestino);
        } catch (DatabaseException e) {
